                ...
                <div class="price-discount-sect">
                        ...
                        <h2 class="list-price">
                            <?php
						        if(@$property['hold_period'] == 'One year'){
						            ...
						            echo "4 years";
						        }elseif(@$property['hold_period'] == 'Five years'){
						            echo "5 years";
						        }elseif(@$property['hold_period'] == 'Six years'){
						            echo "6 years";
						        }else{
						    ...
						    <div class="tooltip"><i class="fa fa-info"></i>
                                <span class="tooltiptext">
                                    a.  Shares can be sold or transferred anytime before maturity.(Refer to FAQ)<br />
                                    b. Rental income is shared and paid quarterly till maturity.
                                </span>
                            </div>
                        </h2>
                    </div>
                    <div class="price-box">
                        ...
                        <h2 class="list-price">
                            ...
                            <div class="tooltip"><i class="fa fa-info"></i>
                                <span class="tooltiptext">
                                    Capital + appreciation gain are paid within 14 days after maturity
                                </span>
                            </div>
                        </h2>
                    </div>
                ...
                <div class="full-disp">
                    ...
                    <div class="half-disp">
                        ...
                        <div class="full-disp">
                            ...
                            <div class="half-disp">
                                <span class="date-top">Completion</span>
                ...
                <div class="highlight-tbl-container">
                    <table cellpadding="5" class="highlight-tbl">
                        ...
                        <tr>
                            ...
                            <?php if($property['hold_period'] == 'Five years' || $property['hold_period'] == 'Six years'){ ?>
                                <td>
                                    <div class="naira-wrapper"><span style="font-family:helvetica;">&#x20A6;</span><?php echo round(($property['marketValue'] * ($property['co_appr_5']/100)/1000000), 1); ?>M</div>
                                    <div class="percentage-wrapper"><?php echo $property['co_appr_5']; ?>%</div>
                                </td>
                                
                            <?php } ?>
                            <?php if($property['hold_period'] == 'Six years'){ ?>
                                <td>
                                    <div class="naira-wrapper"><span style="font-family:helvetica;">&#x20A6;</span><?php echo round(($property['marketValue'] * ($property['co_appr_6']/100)/1000000), 1); ?>M</div>
                                    <div class="percentage-wrapper"><?php echo $property['co_appr_6']; ?>%</div>
                                </td>
                            <?php } ?>
                        </tr>
                        <tr>
                            <th>
                                ...
                                <div class="tooltip"><i class="fa fa-info"></i>
                                <span class="tooltiptext">
                                    Capital plus capital appreciation accrued year over year(YoY) up to maturity date.
                                </span>
                            </th>
                            <td>
                            ...
                            <td>
                                ...
                                <span style="font-family:helvetica;">&#x20A6;</span><?php echo round(($property['marketValue'] + $appr_1 + $appr_2)/1000000, 1); ?>M
                            </td>
                            <td>
                                <?php $appr_3 = $property['marketValue'] * ($property['co_appr_3'] / 100); ?>
                                <span style="font-family:helvetica;">&#x20A6;</span><?php echo round(($property['marketValue'] + $appr_1 + $appr_2 + $appr_3)/1000000, 1); ?>M
                            </td>
                            <td>
                                <?php $appr_4 = $property['marketValue'] * ($property['co_appr_4'] / 100); ?>
                                <span style="font-family:helvetica;">&#x20A6;</span><?php echo round(($property['marketValue'] + $appr_1 + $appr_2 + $appr_3 + $appr_4)/1000000, 1); ?>M
                            </td>
                            <?php if($property['hold_period'] == 'Five years' || $property['hold_period'] == 'Six years'){ ?>
                                <td>
                                    <?php $appr_5 = $property['marketValue'] * ($property['co_appr_5'] / 100); ?>
                                    <span style="font-family:helvetica;">&#x20A6;</span><?php echo round(($property['marketValue'] + $appr_1 + $appr_2 + $appr_3 + $appr_4 + $appr_5)/1000000, 1); ?>M
                                </td>
                                
                            <?php } ?>
                            <?php if($property['hold_period'] == 'Six years'){ ?>
                                <td>
                                    <?php $appr_6 = $property['marketValue'] * ($property['co_appr_6'] / 100); ?>
                                    <span style="font-family:helvetica;">&#x20A6;</span><?php echo round(($property['marketValue'] + $appr_1 + $appr_2 + $appr_3 + $appr_4 + $appr_5 + $appr_6)/1000000, 1); ?>M
                                </td>
                            <?php } ?>
                        </tr>
                    </table>
...
<input type="hidden" class="remaining_pool_units" id="remaining_pool_units" value="<?php echo @$property['available_units']; ?>" />
<input type="hidden" class="pool-total-cost" id="pool-total-cost" value="<?php echo $property['price'] * $property['pool_units']; ?>" />
<input type="hidden" class="property-cost" id="property-cost" value="<?php echo $property['marketValue']; ?>" />
...
<input type="hidden" id="share-cost" class="share-cost" value="<?php echo @$property['price']; ?>" />
...
<script>
    ...
    var remaining_pool_units = $('#current_num_of_shares').val();
	...
	$("#total-output").html("<span style='font-family:helvetica;'>&#x20A6;</span> "+numberWithCommas((amount_of_units * total_cost) + parseInt(default_trans_fee)));
	
	$('#remaining-shares').html(numberWithCommas(remaining_pool_units));
    ...
    jQuery('.share-quantity').each(function() {
      ...
      btnDown.click(function() {
        ...
        if(parseInt(curr_units) === parseInt((remaining_pool_units))){
