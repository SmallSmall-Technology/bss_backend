 ...
 <div class="footer-wrapper">
    <div class="footer-container">
        	...
        	<div class="footer-quick-link-section">
				...
				<div class="footer-grid-box">
          		...
          		<div class="footer-grid-box">
            		...
            		<a class="link-text" href="/">Talk to us</a>
            		<a class="link-text" href="mailto:hello@buysmallsmall.ng">hello@buysmallsmall.ng</a>
  	...
  	<script src="<?php echo base_url(); ?>asset/js/headerSelect.js"></script>
